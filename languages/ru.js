const language = {
   ...
   msg32: "Теперь пришло время слушать музыку на вашем Дискорд сервере с совершенно бесплатным и продвинутным интерфейсом. Музыкальный бот, поддерживающий воспроизведение музыки на многих платформах, сделает ваш сервер особенным.",
   msg33: "Бот-Команды",
